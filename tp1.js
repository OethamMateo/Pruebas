...
// Cargar los textos desde el archivo antes de ejecutar el programa
function preload() {
  textos = loadStrings('data/texto.txt');  // Carga el archivo textos.txt
}

function setup() {
  createCanvas(800, 600);

  // Inicializa los colores de fondo para cada escena
  coloresFondos = [
